...
public class AirControl : MonoBehaviour
{
    ...
    void Update()
    {
        _inputYaw = GameManager.MobileInput.yawInput;
        _inputPitch = GameManager.MobileInput.pitchInput;
        _inputRoll = GameManager.MobileInput.rollInput;

        if (GameManager.MobileInput.isAirRoll)
        {
